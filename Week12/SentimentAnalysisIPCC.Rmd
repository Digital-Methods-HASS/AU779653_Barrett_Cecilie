---
title: 'GOT'
date: 'created on 19 MARCH 2025 and updated `r format(Sys.time(), "%d %B, %Y")`'
...
What if we want to get rid of all the numbers (non-text) in `GOT stop`?
```{r skip-numbers}
